...
final INTERVALS = [
  IntervalType(
      label: "Unisson", id: "int1", semitones: 0, type: 1, isDiatonic: true),
  IntervalType(
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Seconde augmentee",
      id: "int2+",
      semitones: 3,
      type: 2,
      isDiatonic: false),
  IntervalType(
      label: "Tierce diminuee",
      id: "int3-",
      semitones: 2,
      type: 3,
      isDiatonic: false),
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Quarte augmentee",
      id: "int4+",
      semitones: 6,
      type: 4,
      isDiatonic: false),
  IntervalType(
      label: "Quinte diminuee",
      id: "int5-",
      semitones: 6,
      type: 5,
      isDiatonic: false),
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Octave1", id: "int8", semitones: 12, type: 8, isDiatonic: true),
  IntervalType(
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Neuvième augmentee",
      id: "int9+",
      semitones: 15,
      type: 9,
      isDiatonic: false),
  IntervalType(
      label: "Dixième diminuee",
      id: "int10-",
      semitones: 14,
      type: 10,
      isDiatonic: false),
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Onzième augmentee",
      id: "int11+",
      semitones: 18,
      type: 11,
      isDiatonic: false),
  IntervalType(
      label: "Douzième diminuee",
      id: "int12-",
      semitones: 18,
      type: 12,
      isDiatonic: false),
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Treizième augmentee",
      id: "int13+",
      semitones: 22,
      type: 13,
      isDiatonic: false),
  IntervalType(
      label: "Quatorzième diminuee",
      id: "int14-",
      semitones: 21,
      type: 14,
      isDiatonic: false),
  ...
  IntervalType(
      ...
      isDiatonic: true),
  IntervalType(
      label: "Octave2", id: "int15", semitones: 24, type: 15, isDiatonic: true),
];
